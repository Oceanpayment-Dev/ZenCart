<?php
  ...
  define('MODULE_PAYMENT_OCEANPAYMENT_CREDITCARD_TEXT_CONFIG_19_1', 'Write The Logs');
  define('MODULE_PAYMENT_OCEANPAYMENT_CREDITCARD_TEXT_CONFIG_19_2', 'Write The Logs');
